...
switch traj_n
    ...
    case 6      %Infinity shit trajectory
        sp = setp_inf_shit( t, simulation_time, pos_ned_init, pos_ned_fin, attitude_init_eul, altitude, omega, roll, yaw_following, scale , delta_pos_n, delta_pos_e);
        
    case 7      %Circular shit
        sp = setp_circular_shit( t, simulation_time, pos_ned_init, pos_ned_fin, attitude_init_eul, altitude, omega, roll, yaw_following, scale, delta_pos_n, delta_pos_e );
